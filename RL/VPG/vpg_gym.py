...
"""
 model
"""
policy = GaussianPolicy(state_dim, action_dim, env.action_space).to(device)
...
def main_loop():
    for e in range(args.epoch):
        ...
        print(f"total_reward:{log['total_reward']}, average_reward:{log['avg_reward']}, maximum_reward:{log['max_reward']}")
